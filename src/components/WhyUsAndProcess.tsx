...
export default function WhyUsAndProcess() {
  ...
  return (
    <section id="process" className="py-20 bg-white text-slate-900 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Core Philosophy Banner */}
        <div className="bg-gradient-to-r from-rose-50 via-slate-100 to-slate-50 text-slate-900 rounded-3xl p-8 sm:p-12 mb-20 shadow-sm border border-rose-200/80">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="pt-2 flex flex-wrap items-center justify-center gap-3 text-xs sm:text-sm font-semibold text-slate-800">
              <span className="bg-white px-3 py-1.5 rounded-lg border border-slate-200 shadow-xs">1. Understand the transaction</span>
              <span className="bg-white px-3 py-1.5 rounded-lg border border-slate-200 shadow-xs">2. Follow the process</span>
              <span className="bg-white px-3 py-1.5 rounded-lg border border-slate-200 shadow-xs">3. Reconcile the numbers</span>
              <span className="bg-white px-3 py-1.5 rounded-lg border border-slate-200 shadow-xs">4. Review the work</span>
              <span className="bg-white px-3 py-1.5 rounded-lg border border-slate-200 shadow-xs">5. Communicate clearly</span>
            </div>
        ...
        <div className="mb-20">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 text-slate-700 text-xs font-bold uppercase tracking-wider mb-3 border border-slate-200">
