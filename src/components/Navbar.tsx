...
export default function Navbar({ onOpenConsultation }: NavbarProps) {
  ...
  const navLinks = [
    { label: 'Offshore Bookkeeping', href: '#international-bookkeeping' },
  ...
  return (
    <header className="sticky top-0 z-40 w-full transition-all duration-300">
      ...
      <div className="bg-slate-100 text-slate-600 text-xs py-2 px-4 border-b border-slate-200 transition-colors">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 sm:gap-6">
            <a
              href={`tel:${BUSINESS_INFO.contact.phone}`}
              className="flex items-center gap-1.5 hover:text-rose-600 text-slate-700 font-medium transition-colors"
            >
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="hidden sm:flex items-center gap-2 sm:gap-3">
              <a
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-bold text-slate-700 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors border border-slate-200"
              >
          ...
          <div className="xl:hidden bg-white border-t border-slate-200 px-4 pt-4 pb-6 space-y-3 shadow-xl animate-in slide-in-from-top duration-200">
            ...
            <div className="pt-3 border-t border-slate-100 flex flex-col gap-2">
              <button
                ...
                className="w-full py-3 rounded-xl bg-rose-600 hover:bg-rose-700 text-white font-bold text-center text-sm shadow-md cursor-pointer"
              >
