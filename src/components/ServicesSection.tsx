...
export default function ServicesSection({ onOpenConsultationWithService }: ServicesSectionProps) {
  ...
  return (
    <section id="services" className="py-20 bg-slate-50 text-slate-900 relative overflow-hidden transition-colors">
          ...
          <div id="business-guardian" className="space-y-8 animate-in fade-in duration-300">
            <div className="bg-rose-50/80 border border-rose-200 rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <button
                ...
                className="shrink-0 px-6 py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-semibold text-sm transition-colors flex items-center gap-2 shadow-sm cursor-pointer"
              >
            ...
            <div className="bg-amber-50/80 border border-amber-200 rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="shrink-0 flex items-center gap-3">
                ...
                <button
                  ...
                  className="px-6 py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-semibold text-sm transition-colors flex items-center gap-2 shadow-sm cursor-pointer"
                >
                ...
                >
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between">
                    <button
                      type="button"
                      onClick={() => onOpenConsultationWithService?.(srv.title)}
                      className="text-xs font-bold text-amber-700 hover:text-amber-800 flex items-center gap-1 group cursor-pointer"
                    >
