...
export default function InternationalSupport({ onOpenConsultation }: InternationalSupportProps) {
  return (
    <section id="international-bookkeeping" className="py-20 bg-white text-slate-900 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-950 text-white rounded-3xl p-8 sm:p-12 shadow-2xl border border-slate-800 relative overflow-hidden mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
                <div className="p-3.5 rounded-xl bg-slate-800/80 border border-slate-700">
                  ...
                  <div className="text-xs text-slate-300 font-semibold mt-0.5">Staffing & Overhead Costs</div>
                </div>
                ...
                <div className="p-3.5 rounded-xl bg-slate-800/80 border border-slate-700">
                  ...
                  <div className="text-xs text-slate-300 font-semibold mt-0.5">Reconciliation SLA</div>
                </div>
                ...
                <div className="p-3.5 rounded-xl bg-slate-800/80 border border-slate-700 col-span-2 sm:col-span-1">
                  ...
                  <div className="text-xs text-slate-300 font-semibold mt-0.5">White-Label Behind Your Brand</div>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 bg-slate-800/90 rounded-2xl p-6 border border-slate-700 space-y-3">
              <h4 className="text-sm font-bold text-slate-200 flex items-center gap-2 pb-2 border-b border-slate-700">
              ...
              <p className="text-[11px] text-slate-400 pt-2 border-t border-slate-700/80 leading-relaxed italic">
